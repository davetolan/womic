...
export async function generateStaticParams() {
  try {
    ...
    console.error('[generateStaticParams:/[slug]] Failed to load pages during build. Continuing with runtime rendering.', error)
    return []
  }
}
...
const queryPageBySlug = cache(async ({ slug }: { slug: string }) => {
  try {
    ...
    console.error(`[queryPageBySlug] Failed to fetch page "${slug}".`, error)
    return null
  }
})
